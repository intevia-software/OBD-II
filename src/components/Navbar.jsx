  ...
  return (
    ...
    <div className="w-full bg-gray-900 p-2 flex justify-between items-center lg:px-16 border-b border-gray-700 ">
        ...
        <div className="container mx-auto flex justify-between">
            ...
            <div className="">
                <Menu >
                    <MenuButton className="mx-1 py-2 px-4 bg-gray-700 text-gray-100 text-xs border-none outline-none rounded hover:bg-gray-800 transition duration-200"><FontAwesomeIcon icon={faCar} /> Module</MenuButton>
